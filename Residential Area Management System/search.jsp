...
<%
	dbCon.connect();
	String sql = "SELECT people.id, fname, lname, dob, gender, contact, areas.area, address.pincode, address.street, address.house FROM people, address, areas WHERE people.id = address.id AND address.pincode = areas.pincode AND people.id = '" + request.getParameter("id") + "'";
